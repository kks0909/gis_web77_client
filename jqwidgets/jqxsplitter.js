...
(function (a) {
    ...
    a.extend(a.jqx._jqxSplitter.prototype, {defineInstance: function () {
        ...
        this.panel1 = null;
        this.panel2 = null;
        this._eventsMap = {mousedown: a.jqx.mobile.getTouchEventName("touchstart"), mouseup: a.jqx.mobile.getTouchEventName("touchend"), mousemove: a.jqx.mobile.getTouchEventName("touchmove"), mouseenter: "mouseenter", mouseleave: "mouseleave"};
