...
(function (a) {
	a.jqx.jqxWidget("jqxBaseLayersList", "", {});
	a.extend(a.jqx._jqxBaseLayersList.prototype, {
		defineInstance: function () {
			...
			if (a.jqx._jqxListBox == null || a.jqx._jqxListBox == undefined) {
				throw new Error("jqxBaseLayersList: Missing reference to jqxlistbox.js.")
			}
			var h = this;
			...
			var g,gg, h = parseInt(Math.round(this.host.coord(true).left));
			g = h + "px";
			gg = h+this.width+"px";
			...
			var b = a.data(this.element, "jqxBaseLayersList");
			if (b) {
				delete b.instance
			}
