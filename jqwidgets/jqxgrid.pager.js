...
(function (a) {
    a.extend(a.jqx._jqxGrid.prototype, {_initpager: function () {
        var r = this.that;
        ...
        //добавил defaultPagerHeight чтобы отступы внутри pager'a считались не от this.pagerheight а от его дефолтного значения (28)
        var defaultPagerHeight = 28;
        var m = (defaultPagerHeight - 17) / 2; //(this.pagerheight - 17) / 2;
        this.pagerdiv = this.pagerdiv || a('<div style="width: 100%; position: relative;"></div>');
        if (!this.pageable) {
        ...
        if (!this.pagerrenderer) {
            ...
            //Исправлено, чтобы pager располагался над содержимым грида, в toolbar-е
            if (this.toolbar) {
                this.toolbar.append(this.pagerdiv);
            } else {
            ...
            //upd. 26.04.21
            this.pagergotoinput.css("display", 'none');
            this.pagergoto.css("display", 'none');
            ...
            //upd. 26.04.21 в рамках оптимизации скорости отрисовки грида и исключения запроса на количество записей убираем кнопку,
            // т.к. при переходе на страницу 99999 и назад у 1-й записи ширина колонки с чекбоксом увеличивалась на всю ширину грида
            //this.pagerlastbutton = a('<div type="button" style="padding: 0px; margin-top: 0px; margin-right: 3px; width: 27px; float: right;"></div>');
            this.pagerlastbutton = a('<div type="button" style="display:none; padding: 0px; margin-top: 0px; margin-right: 3px; width: 27px; float: right;"></div>');
            ...
            /*Добавляем кнопки "в начало" и "в конец" к обоим модам*/
            ...
            if (!this.rtl) {
                ...
                /*Кнопки каждой страницы добавляем только если this.pagermode == "simple"*/
                if (this.pagermode == "simple") { this.pagerdiv.append(this.pagerbuttons); }
            ...
            /*Выравниваем позицию всех контролов в зависимости от rtl*/
            ...
            this.pagergoto.css("float", t);
            this.pagergotoinput.css("float", t);
            this.pagershowrows.css("float", t);
            this.pagershowrowscombo.css("float", t);
            this.pagerdetails.css("float", t);
            ...
            /*для мода "simple" прячем лишние компоненты*/
            ...
            this.pagershowrowscombo.jqxDropDownList({rtl: this.rtl, disabled: this.disabled, source: o, enableBrowserBoundsDetection: true, keyboardSelection: false, autoDropDownHeight: true, width: "auto", height: 16, theme: this.theme});
            var q = 0;
            ...
            var f = this;
            /*Условие убрано, т.к. добавляем кнопки "в начало" и "в конец" к обоим модам */
            /*if (this.pagermode === "simple") {*/
        ...
        if (this.pagerdetails != null && this.pagerdetails.length > 0) {
            ...
            //upd. 26.04.21 сказано убрать из всех гридов текст " из 4" с количеством страниц
            if (!this.rtl) {
