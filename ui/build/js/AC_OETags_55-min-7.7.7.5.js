...
//генерация модуля
function AC_GenerateobjModule(objAttrs, params, embedAttrs, parentElementId)
{
    var str = '';
    if (isIE && isWin && !isOpera)
    {
    ...
    //document.write(str);
    $('#'+parentElementId).html(str);
};
function AC_FL_RunContentModule(){
    var ret =
        AC_GetArgsModule
        (  arguments, ".swf", "movie", "clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
            , "application/x-shockwave-flash"
        );
    AC_GenerateobjModule(ret.objAttrs, ret.params, ret.embedAttrs, ret.parentElementId);
};


function AC_GetArgsModule(args, ext, srcParamName, classid, mimeType){
    var ret = new Object();
    ret.embedAttrs = new Object();
    ret.params = new Object();
    ret.objAttrs = new Object();
