...
module.exports = function(defs) {
  ...
  defs('EPSG:3857', "+title=Google Mercator EPSG:3857 +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +ellps=WGS84 +datum=WGS84 +units=m +nadgrids=@null +no_defs");//"+title=WGS 84 / Pseudo-Mercator +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +units=m +nadgrids=@null +no_defs");
  defs('EPSG:900913', "+title=Google Mercator EPSG:900913 +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +ellps=WGS84 +datum=WGS84 +units=m +nadgrids=@null +no_defs");
  defs('EPSG:4284', "+title=Pulkovo 1942 longitude-latitude +proj=longlat +ellps=krass +towgs84=26.3,-132.6,-76.3,0.2199982547,0.4,0.89999957,-0.12 ");
  /*for(var aa=0; aa<=26;aa++){
    defs("EPSG:326"+(aa+34),"+proj=utm +zone="+(aa+34)+" +datum=WGS84 +units=m +no_defs");
  }*/
  defs('EPSG:32634', "+title=WGS 84 / UTM zone 34N +proj=utm +zone=34 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32635', "+title=WGS 84 / UTM zone 35N +proj=utm +zone=35 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32636', "+title=WGS 84 / UTM zone 36N +proj=utm +zone=36 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32637', "+title=WGS 84 / UTM zone 37N +proj=utm +zone=37 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32638', "+title=WGS 84 / UTM zone 38N +proj=utm +zone=38 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32639', "+title=WGS 84 / UTM zone 39N +proj=utm +zone=39 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32640', "+title=WGS 84 / UTM zone 40N +proj=utm +zone=40 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32641', "+title=WGS 84 / UTM zone 41N +proj=utm +zone=41 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32642', "+title=WGS 84 / UTM zone 42N +proj=utm +zone=42 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32643', "+title=WGS 84 / UTM zone 43N +proj=utm +zone=43 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32644', "+title=WGS 84 / UTM zone 44N +proj=utm +zone=44 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32645', "+title=WGS 84 / UTM zone 45N +proj=utm +zone=45 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32646', "+title=WGS 84 / UTM zone 46N +proj=utm +zone=46 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32647', "+title=WGS 84 / UTM zone 47N +proj=utm +zone=47 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32648', "+title=WGS 84 / UTM zone 48N +proj=utm +zone=48 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32649', "+title=WGS 84 / UTM zone 49N +proj=utm +zone=49 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32650', "+title=WGS 84 / UTM zone 50N +proj=utm +zone=50 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32651', "+title=WGS 84 / UTM zone 51N +proj=utm +zone=51 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32652', "+title=WGS 84 / UTM zone 52N +proj=utm +zone=52 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32653', "+title=WGS 84 / UTM zone 53N +proj=utm +zone=53 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32654', "+title=WGS 84 / UTM zone 54N +proj=utm +zone=54 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32655', "+title=WGS 84 / UTM zone 55N +proj=utm +zone=55 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32656', "+title=WGS 84 / UTM zone 56N +proj=utm +zone=56 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32657', "+title=WGS 84 / UTM zone 57N +proj=utm +zone=57 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32658', "+title=WGS 84 / UTM zone 58N +proj=utm +zone=58 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32659', "+title=WGS 84 / UTM zone 59N +proj=utm +zone=59 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");
  defs('EPSG:32660', "+title=WGS 84 / UTM zone 60N +proj=utm +zone=60 +ellps=WGS84 +datum=WGS84 +units=m +no_defs");

  defs.WGS84 = defs['EPSG:4326'];
  defs['EPSG:3785'] = defs['EPSG:3857']; // maintain backward compat, official code is 3857
  defs.GOOGLE = defs['EPSG:3857'];
//  defs['EPSG:900913'] = "+title=Google Mercator EPSG:900913 +proj=merc +a=6378137 +b=6378137 +lat_ts=0.0 +lon_0=0.0 +x_0=0.0 +y_0=0 +k=1.0 +ellps=WGS84 +datum=WGS84 +units=m +nadgrids=@null +no_defs"//defs['EPSG:3857'];
...
if ((source.title.indexOf('EPSG:900913') != -1 && dest.datumCode != "WGS84") ||
    (dest.title.indexOf('EPSG:900913') != -1 && source.datumCode != "WGS84")) {
